...
#### Avoid Concurrent Usage of PocketBase

Do not run the PocketBase instance via Docker and the local instance simultaneously. Since they share the same SQL file, it will be locked, and unexpected behaviours and errors will happen.
</Alert>
...
- <div>
    ...
    <span>
      ...
      [here](https://pocketbase.io/), or use `bun forge db init` command to
      automatically download and set it up for you.
    </span>
  </div>
